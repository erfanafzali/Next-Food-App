  ...
  return (
    <div className="w-full flex  lg:flex-row justify-center items-center gap-x-20 gap-y-12 flex-col-reverse">
      <div className="lg:order-none order-">
        <h2 className="font-bold text-2xl w-fit border-b-4 border-green-600 pb-1 mb-4">Food App</h2>
        <div>
        ...
        <button className="bg-green-500 hover:bg-green-400 duration-500 transition  px-8 py-1.5 text-white font-semibold rounded-md mt-6">See All</button>
      </div>
      <img
